    ...
    return(
      <div>
        ...
        <div className="tutorial">
          ...
          <p className="emphaB">
            1.サイトの上部にある緑色のバー↓</p>
                    ...
                    <AllMenu/>
          <p className="flow">                    
          は現在取り組んでいる作業を確認することができます。リーンキャンバスに取り組んでいるときは、<br/>バーのリーンキャンバスの部分がオレンジ色に変わります。現在はトップ画面なのでトップがオレンジ色になっています。<br/>
          ...
          <p className="obj">
           ...
           このページにおいては、Backを押しても移動はしませんが、Nextを押せばリーンキャンバスへ移動できます。<br/><br/>
          <p className="emphaB">           
        ...
        <ShowGuide  onClick={() => null} />
            ...
            例えばリーンキャンパスの画面でクリックすれば、リーンキャンバスの取り組み方の説明が表示されます。<br/>このページにおいてはクリックしても反応しません。
